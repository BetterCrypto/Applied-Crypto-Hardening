...
Any key length up to 8196 is supported and it does not need to be a power of two.
All system ciphers and digests are supported, viz. those in the list generated by
\begin{lstlisting}[breaklines]
