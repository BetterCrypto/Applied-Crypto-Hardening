...
\begin{itemize*}
  \item 4.2.0 with OpenSSL 1.0.1e on RHEL 6.5
\end{itemize*}

As of v4.2 there is support for forward secrecy trough elliptic curve ciphers. Previous versions
had no support for forward secrecy. Also v4.2 adds support for setting HSTS and configuring TLS
minor versions on or off. The below configuration is valid for any ATS version newer than at least
3.2.5, with the v4.2 options commented out.
\end{itemize*}

\paragraph*{records.config}
\begin{lstlisting}
