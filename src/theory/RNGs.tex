...
On Linux, always read from \verb+/dev/urandom+, never \verb+/dev/random+.
If you're developing an application that runs during the system boot
or on embededded devices, poll \verb+/dev/random+ until it's ready. This
will tell you that \verb+/dev/urandom+ has been seeded by the kernel.
