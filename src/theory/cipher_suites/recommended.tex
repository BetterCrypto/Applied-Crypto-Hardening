...
At the time of this writing only Win 7 and Win 8.1 crypto stack, Opera 17,
OpenSSL $\ge$ 1.0.1e, Safari 6 / iOS 6.0.1 and Safar 7 / OS X 10.9
are covered by that cipher string.

\todo{does Opera 17 really work with that cipher string?}

In case you need to support other/different clients, see
\ref{section:ChoosingYourOwnCipherSuites}.
