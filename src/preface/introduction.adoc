...
Ecrypt II, ENISA’s report on Algorithms, key sizes and parameters and BSI’s
Technische Richtlinie TR-02102 are great publications which are more in depth
...
engineering attacks, protection against tempest attack techniques, thwarting
...
comprehensive book _Security Engineering_ by Ross Anderson.
...
requests on the
link:https://github.com/BetterCrypto/Applied-Crypto-Hardening[github mirror] for
this paper.
