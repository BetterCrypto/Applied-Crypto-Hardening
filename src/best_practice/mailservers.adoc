...
// FIXME: RFC bib item 'RFC 5114 (ike23)'
...
SSL Configuration, see figure <<ach_ironport_ssl_settings>>).  For all versions
...
[#ach_ironport_ssl_settings]
image::ach_ironport_ssl_settings.png[IronPort Default SSL Settings,scaledwidth=80.0%]
...
Listeners, see figure <<ach_ironport_ssl_settings>>). Afterwards, for each
...
Flow Policies, see figure <<ach_ironport_ssl_settings>>). It is recommended to
...
[#ach_ironport_listener_cert]
image::ach_ironport_listener_cert.png[IronPort Listener Settings,scaledwidth=80.0%]

// FIXME: delete? {empty}[[ach_ironport_listener_cert]][ach_ironport_listener_cert]

.IronPort Mail Flow Policy Security Features
[#ach_ironport_mail_flow_tls]
image::ach_ironport_mail_flow_tls.png[IronPort Mail Flow Policy Security Features,scaledwidth=80.0%]

// FIXME: delete? {empty}[[ach_ironport_mail_flow_tls]][ach_ironport_mail_flow_tls]
...
figure <<ach_ironport_dest_control>> on page . To enforce TLS for a specific
destination domain, add an entry to the Destination Control Table and set ``TLS
Support'' to ``required''.

.IronPort Destination Control overview
[#ach_ironport_dest_control]
image::ach_ironport_dest_control.png[Destination Control overview,scaledwidth=80.0%]

// FIXME: delete? {empty}[[ach_ironport_dest_control]][ach_ironport_dest_control]
